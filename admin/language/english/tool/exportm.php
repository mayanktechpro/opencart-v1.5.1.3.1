...
$_['heading_title_romanian']     = 'Export / Import (Insert) For Romanian Language only';

// Text
$_['text_success']      = 'Success: You have successfully imported your categories and products!';
$_['text_success_romanian']      = 'Success: You have successfully imported missing fields for products in Romanian Language!';

// Entry
$_['entry_restore']     = 'Import from spreadsheet file:';
$_['entry_restore_romanian']     = 'Import from spreadsheet file for romanian language:';
...
$_['entry_description_romanian'] = 'Use this function to export or import Missing Fields for Romanian Language (Language ID -2).';
...
$_['error_romanian_header']   = 'Export/Import: Invalid header in the Romanian Language worksheet';
$_['error_sheet_count_romanian'] = 'Export/Import: Invalid number of worksheets, 1 worksheet expected';
// Button labels
